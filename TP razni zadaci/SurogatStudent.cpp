...
public:
    ...
    Student(const Student& s):
        student(!s.student ? nullptr :s.student->DajKopiju()){}
    Student(Student &&s)
        : student(std::move(s.student)){}
    Student& operator=(const ApstraktniStudent& s){
        ApstraktniStudent* t = s.DajKopiju(); delete student;
        student = t; return *this;
    }
    Student operator=(Student&& s){
        ApstraktniStudent* t = std::move(s.student); delete student;
        student = t; return *this;
    }
    Student& operator=(const Student& s){
        ApstraktniStudent* t = (!s.student ? nullptr : s.student->DajKopiju());
        delete student; student = t; return *this;
    }
    ~Student(){
        delete student;
    }
    //dodati sve ostale funkcije
};
...
StudentBachelor* StudentBachelor::DajKopiju() const
{
    return new StudentBachelor(*this);
}

StudentMaster* StudentMaster::DajKopiju() const
{
